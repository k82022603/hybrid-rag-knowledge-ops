...
| 문서 | 경로 |
|------|------|
| **Hybrid RAG Platform** | `knowledge_service/docs/02_design/hybrid_rag_platform_detailed_design.md` |
| **Infrastructure** | `knowledge_service/docs/02_design/infrastructure_detailed_design.md` |
| **Backend** | `knowledge_service/docs/02_design/backend_detailed_design.md` |
| **Frontend** | `knowledge_service/docs/02_design/frontend_detailed_design.md` |
| **API Integration** | `knowledge_service/docs/02_design/api_integration_design.md` |
| **Auth/AuthZ** | `knowledge_service/docs/02_design/authentication_authorization_detailed_design.md` |
| **Observability** | `knowledge_service/docs/02_design/observability_detailed_design.md` |
| **RAG Performance Test** | `knowledge_service/docs/02_design/rag_performance_test_design.md` |
