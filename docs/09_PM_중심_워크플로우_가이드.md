...
stateDiagram-v2
    [*] --> ToDo: 이슈 생성
    ToDo --> InProgress: PM이 작업 할당 시<br/>transition id: 21
    InProgress --> Done: PM이 완료 보고 시<br/>transition id: 31
    Done --> [*]
...
- [Jira Slack 실전 매뉴얼](docs/08_Jira_Slack_Claude_Code_실전_매뉴얼.md)
