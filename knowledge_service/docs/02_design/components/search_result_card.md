...
> ⚠️ **Migration Notice (2026-01-25)**
>
> 이 문서는 MUI 기반 구현 예시를 포함하고 있습니다.
> **Tailwind CSS + Headless UI + Heroicons** 마이그레이션 예정입니다.
>
> | 현재 | 전환 후 |
> |------|---------|
> | `@mui/material` | Tailwind CSS + Headless UI |
> | `@mui/icons-material` | Heroicons |
> | `Box`, `Card`, `Typography` | `<div>`, `<article>` + Tailwind 클래스 |
> | `sx` prop | `className` + Tailwind 유틸리티 |
>
> 마이그레이션 가이드: [04.Tailwind_Antigravity_Stitch_도입_영향도_분석.md](../../../docs/technical_assessment/Guides/04.Tailwind_Antigravity_Stitch_도입_영향도_분석.md)
