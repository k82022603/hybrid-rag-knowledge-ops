...
> **참고**: Kubernetes 기반 확장 설계가 필요한 경우 `technical_assessment/04_infrastructure_k8s_reference_design.md` 문서를 참조하세요.
...
> **참고**: 상세 사용 가이드는 `docs/07_maintenance/02_kibana_user_guide.md`를 참조하세요.
...
| 문서 | 위치 |
|------|------|
| K8s 참조 설계 | [technical_assessment/04_infrastructure_k8s_reference_design.md](./technical_assessment/04_infrastructure_k8s_reference_design.md) |
