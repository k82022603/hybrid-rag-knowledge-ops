...
| `docs/04_testing/11_ragas/results/07_RAGAS_평가_총평.md` | RAGAS 평가 전체 요약 |
| `docs/04_testing/11_ragas/results/08_RAGAS_v5_50쿼리_평가결과.md` | v5 50쿼리 평가 결과 분석 |
| `docs/04_testing/11_ragas/results/09_RAGAS_크로스시스템_최종분석.md` | 크로스시스템 최종 분석 |
| `docs/04_testing/11_ragas/results/05_hrkp_vs_rcsv_report_2026-02-10_v4.md` | v4 크로스시스템 평가 상세 |
