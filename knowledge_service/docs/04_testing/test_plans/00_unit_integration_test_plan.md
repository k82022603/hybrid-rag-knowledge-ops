...
| **상태** | Draft |
| **관련 문서** | [백엔드 설계서](../02_design/06_backend_detailed_design.md), [API 통합 설계서](../02_design/04_api_integration_design.md), [RAG 성능 테스트 설계서](../02_design/12_rag_performance_test_design.md) |
...
| 성능 테스트 | 별도 문서로 관리 | [RAG 성능 테스트 설계서](../02_design/12_rag_performance_test_design.md) |
...
| 문서 | 위치 |
|------|------|
| 백엔드 상세 설계서 | [backend_detailed_design.md](../02_design/06_backend_detailed_design.md) |
| API 통합 설계서 | [api_integration_design.md](../02_design/04_api_integration_design.md) |
| RAG 성능 테스트 설계서 | [rag_performance_test_design.md](../02_design/12_rag_performance_test_design.md) |
| 에러 코드 표준 | [error_code_standards.md](../02_design/08_error_code_standards.md) |
