...
| **Related Docs** | [Sprint 04 E2E Test Plan](./sprint04_e2e_test_plan.md), [Sprint 02 E2E Plan](./e2e_test_plan_sprint02.md), [API Integration Design](../02_design/api_integration_design.md), [Security Issue Report](../02_design/sprint04_security_issue_report.md), [Unit/Integration Test Plan](./unit_integration_test_plan.md), [Day 1 E2E Results](../results/sprint04_day1_e2e_test_results.md) |
...
From the [Sprint 04 Security Issue Report](../02_design/sprint04_security_issue_report.md):
...
| Security Issue Report | `knowledge_service/docs/02_design/sprint04_security_issue_report.md` | OWASP findings |
