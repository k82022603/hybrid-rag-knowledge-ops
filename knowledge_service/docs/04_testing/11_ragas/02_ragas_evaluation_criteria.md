...
| 총평 | `docs/04_testing/11_ragas/results/` | `07_RAGAS_평가_총평.md` (누적 업데이트) |
...
| 문서 | 경로 | 설명 |
|------|------|------|
| 크로스 시스템 평가 가이드 | `docs/04_testing/11_ragas/04_ragas_cross_system_evaluation_guide.md` | HRKP vs RCSV 비교 평가 방법 |
| v5 50쿼리 평가 결과 | `docs/04_testing/11_ragas/results/08_RAGAS_v5_50쿼리_평가결과.md` | 최신 평가 결과 상세 |
| RAGAS 평가 총평 | `docs/04_testing/11_ragas/results/07_RAGAS_평가_총평.md` | 7회 평가 이력 종합 분석 |
