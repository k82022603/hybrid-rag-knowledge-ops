...
| `docs/06_deployment/github_actions_secrets_guide.md` | 시크릿 설정 가이드 |
...
| 문서 | 경로 |
|------|------|
| Branch Protection 설정 가이드 | `docs/06_deployment/branch_protection_guide.md` |
| GitHub Actions Secrets 가이드 | `docs/06_deployment/github_actions_secrets_guide.md` |
| Deployment Plan | `docs/06_deployment/deployment_plan.md` |
| 인프라 설계서 | `docs/02_design/infrastructure_detailed_design.md` |
| DevOps 설계서 | `docs/02_design/devops_detailed_design.md` |
