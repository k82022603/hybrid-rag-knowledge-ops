...
description: (devops) DevOps Engineer - CI/CD 및 Observability
...
> **Infra Engineer 에이전트와의 차이점**:
> - **DevOps Engineer**: **운영 자동화** (CI/CD, 모니터링, 알림)
> - **Infra Engineer**: **환경 구축** (Docker Compose 설정, 컨테이너 구성)
